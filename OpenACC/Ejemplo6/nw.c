...
void runTest( int argc, char** argv) 
{
	...
	#pragma acc data copy_in(input1[0:max_cols])
	#pragma acc data copy_in(input2[0:max_rows])
	#pragma acc data copy_in(blosum62[0:24*24])
	#pragma acc data copy(nw_matrix[0:max_rows * max_cols])
	{
